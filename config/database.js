...
try {
    ...
    if (tableExists("movies")) {
        ...
        const catalog = [
            ...
            ["Top Gun: Maverick", "After decades of service, Maverick trains a new generation of elite pilots for a dangerous mission.", "Action", 131, "2022-05-27", 8.3, "https://theestablishingshot.org/wp-content/uploads/2022/05/top_gun_maverick_poster.jpg"],
        ...
        db.prepare("UPDATE movies SET poster = ? WHERE title = ?")
            .run("https://theestablishingshot.org/wp-content/uploads/2022/05/top_gun_maverick_poster.jpg", "Top Gun: Maverick");
    }
