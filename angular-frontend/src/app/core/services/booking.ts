...
export class BookingService {
  ...
  createBooking(b: CreateBookingRequest): Observable<{ message: string; bookingId: number; booking: Booking }> {
    return this.http.post<{ message: string; bookingId: number; booking: Booking }>(
      this.apiUrl,
      b,
